...
def test_add_new_pet_with_valid_data(name='Мэттью', animal_type='Олень северный',
                                     age='3', pet_photo='images/deer.jpg'):
...
def test_successful_delete_own_pet():
    ...
    if len(my_pets['pets']) == 0:
        ptFnd.add_new_pet(auth_key, 'Джош', 'Олень-дэнсер', '4', 'images/deer.jpg')
        _, my_pets = ptFnd.get_list_of_pets(auth_key, 'my_pets')
...
def test_successful_update_own_pet_info(name='Патрик', animal_type='Олень неповторимый', age='6'):
...
def test_add_new_pet_without_photo_with_valid_data(name='Уилл', animal_type='Зебра легендарная', age='5'):
...
def test_add_new_pet_with_incorrect_age(name='Алиса', animal_type='Зебра-шпионка',
